...
// This is called a standalone script. It is made just to populate some database with some docs
console.log(
...
const userArgs = process.argv.slice(2) //! extract connection key from Db
...
mongoose.set('strictQuery', false) // Mongoose will catch query errors for you

const mongoDB = userArgs[0] //! extract connection key from Db

main().catch((err) => console.log(err)) //! start EVERYTHING
